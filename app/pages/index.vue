<template>
  <UContainer class="flex items-center flex-col gap-10 max-w-md">
    <BackgroundSnowfallBg
      color="ADD8E6"
      class="absolute min-h-screen inset-0 z-[-3]"
      :min-radius="0.2"
      :max-radius="5"
      :speed="0.5"
    />
    ...
    <RevealName/>
    <div class="flex flex-col gap-4 rounded bg-neutral-200/90 dark:bg-neutral-800/80 p-3 items-center">
